...
export const en = defineConfig({
  description: 'Olinc Admin & Enterprise level management system framework',
  lang: 'en-US',
  themeConfig: {
    ...
    editLink: {
      pattern:
        'https://github.com/JackZong/olinc/edit/main/docs/src/:path',
      text: 'Edit this page on GitHub',
    },
    footer: {
      copyright: `Copyright © 2020-${new Date().getFullYear()} Olinc`,
...
function nav(): DefaultTheme.NavItem[] {
  return [
    ...
    },
    {
      ...
      items: [
        {
          link: 'https://github.com/JackZong/olinc/releases',
          text: 'Changelog',
        },
        {
        ...
        {
          link: 'https://github.com/JackZong/olinc/blob/main/.github/contributing.md',
          text: 'Contribution',
        },
      ],
    },
