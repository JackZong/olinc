...
import { alert, confirm, OlincButton } from '@olinc/common-ui';
...
<template>
  <div class="flex gap-4">
    <OlincButton @click="showConfirm">Confirm</OlincButton>
    <OlincButton @click="showIconConfirm">Confirm With Icon</OlincButton>
    <OlincButton @click="showfooterConfirm">Confirm With Footer</OlincButton>
    <OlincButton @click="showAsyncConfirm">Async Confirm</OlincButton>
  </div>
</template>
