...
import { alert, prompt, useAlertContext, OlincButton } from '@olinc/common-ui';
...
<template>
  <div class="flex gap-4">
    <OlincButton @click="showPrompt">Prompt</OlincButton>
    <OlincButton @click="showSlotsPrompt"> Prompt With slots </OlincButton>
    <OlincButton @click="showSelectPrompt">Prompt With Select</OlincButton>
    <OlincButton @click="showAsyncPrompt">Prompt With Async</OlincButton>
  </div>
</template>
