...
hero:
  ...
  image:
    src: https://unpkg.com/@olincjs/static-source@0.1.7/source/logo-v1.webp
    alt: Olinc Admin
  actions:
    - theme: brand
      text: 快速开始 ->
    ...
    - theme: alt
      text: 在线预览
      link: https://www.olinc.pro
    - theme: alt
      text: 在 GitHub 查看
      link: https://github.com/JackZong/olinc
    - theme: alt
      text: DeepWiki 文档
      link: https://deepwiki.com/olincjs/vue-olinc-adminn
...
const members = [
  {
    ...
    name: 'Olinc',
    title: '创建者',
    desc: 'Olinc Admin以及相关生态的作者，负责项目的整体开发。',
    links: [
