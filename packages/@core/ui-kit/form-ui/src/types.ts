...
import type { OlincButtonProps } from '@olinc-core/shadcn-ui';
import type { ClassType, MaybeComputedRef } from '@olinc-core/typings';
...
export interface ActionButtonOptions extends OlincButtonProps {
  [key: string]: any;
  content?: MaybeComputedRef<string>;
  show?: boolean;
}

export interface OlincFormProps<
  T extends BaseFormComponentType = BaseFormComponentType,
> extends Omit<
  FormRenderProps<T>,
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<OlincFormProps>>(
    selector?: (state: NoInfer<OlincFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface OlincFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
