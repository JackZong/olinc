...
import type { ExtendedFormApi, FormActions, OlincFormProps } from './types';

import { computed, unref, useSlots } from 'vue';

import { createContext } from '@olinc-core/shadcn-ui';
import {
  isString,
...
type ExtendFormProps = OlincFormProps & { formApi?: ExtendedFormApi };
...
export function useFormInitial(
  props: ComputedRef<OlincFormProps> | OlincFormProps,
) {
