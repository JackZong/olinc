...
import { Input, OlincRenderContent } from '@olinc-core/shadcn-ui';
import { isFunction, isString } from '@olinc-core/shared/utils';
...
export async function vbenPrompt<T = any>(
  ...
  const staticContents: Component[] = [
    h(OlincRenderContent, { content, renderBr: true }),
  ];
