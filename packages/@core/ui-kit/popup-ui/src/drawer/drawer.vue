...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '@olinc-core/composables';
import { X } from '@olinc-core/icons';
import {
  OlincHelpTooltip,
  Separator,
  Sheet,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@olinc-core/shared/constants';
import { globalShareState } from '@olinc-core/shared/global-state';
import { cn } from '@olinc-core/shared/utils';
...
<template>
  ...
  >
    ...
    >
        ...
        <div class="flex items-center">
          ...
          <SheetTitle v-if="title" class="text-left">
            <slot name="title">
              ...
              <OlincHelpTooltip v-if="titleTooltip" trigger-class="pb-1">
                {{ titleTooltip }}
              </OlincHelpTooltip>
            </slot>
          </SheetTitle>
      ...
      <OlincLoading v-if="showLoading || submitting" spinning />
      <SheetFooter
        v-if="showFooter"
        :class="
          cn(
      ...
      >
        ...
        <slot name="footer">
          <component
            :is="components.DefaultButton || OlincButton"
          ...
          <component
            :is="components.PrimaryButton || OlincButton"
