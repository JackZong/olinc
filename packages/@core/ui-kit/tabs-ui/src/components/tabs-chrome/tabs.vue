...
import type { TabDefinition } from '@olinc-core/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed, ref } from 'vue';

import { Pin, X } from '@olinc-core/icons';
import { OlincContextMenu, OlincIcon } from '@olinc-core/shadcn-ui';

interface Props extends TabsProps {}

defineOptions({
  name: 'OlincTabsChrome',
  inheritAttrs: false,
});

const props = withDefaults(defineProps<Props>(), {
  contentClass: 'olinc-tabs-content',
  contextMenus: () => [],
  gap: 7,
  tabs: () => [],
});
