...
import { OlincLoading, OlincSpinner } from '@olinc-core/shadcn-ui';
import { isString } from '@olinc-core/shared/utils';
...
const loadingDirective: Directive = {
  mounted(el, binding) {
    const instance = h(OlincLoading, getOptions(binding));
    render(instance, el);
...
const spinningDirective: Directive = {
  mounted(el, binding) {
    const instance = h(OlincSpinner, getOptions(binding));
    render(instance, el);
