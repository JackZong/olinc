...
import type { TabDefinition } from '@olinc/types';

import type { IContextMenuItem } from '@olinc-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@olinc/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { getTabKey, useAccessStore, useTabbarStore } from '@olinc/stores';
import { filterTree } from '@olinc/utils';
