...
import { useScrollLock } from '@olinc-core/composables';
import { useOlincForm, z } from '@olinc-core/form-ui';
import { OlincAvatar, OlincButton } from '@olinc-core/shadcn-ui';

import { LockKeyhole } from '@olinc/icons';
import { $t, useI18n } from '@olinc/locales';
import { storeToRefs, useAccessStore } from '@olinc/stores';
...
const [Form, { form, validate, getFieldComponentRef }] = useOlincForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    schema: computed(() => [
      {
        component: 'OlincInputPassword' as const,
        componentProps: {
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[90%] max-w-[300px] px-4">
          <OlincAvatar :src="avatar" class="enter-x mb-6 size-20" />
          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <OlincButton class="enter-x w-full" @click="handleSubmit">
