...
import { Bell, CircleCheckBig, CircleX, MailCheck } from '@olinc/icons';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <OlincIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <OlincScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <OlincButton size="sm" @click="handleViewAll">
