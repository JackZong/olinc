import type { VxeTableGridOptions } from '@olinc/plugins/vxe-table';
...
import { IconifyIcon } from '@olinc/icons';
import { $te } from '@olinc/locales';
import {
  setupOlincVxeTable,
  useOlincVxeGrid as useGrid,
} from '@olinc/plugins/vxe-table';
import { get, isFunction, isString } from '@olinc/utils';
...
export const useOlincVxeGrid = <T extends Record<string, any>>(
