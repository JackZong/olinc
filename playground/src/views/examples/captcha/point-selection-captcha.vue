...
import type { CaptchaPoint } from '@olinc/common-ui';

import { reactive, ref } from 'vue';

import { Page, PointSelectionCaptcha } from '@olinc/common-ui';
import { Card, Input, InputNumber, message, Switch } from 'ant-design-vue';

import { $t } from '@/locales';

const DEFAULT_CAPTCHA_IMAGE =
  'https://unpkg.com/@olincjs/static-source@0.1.7/source/default-captcha-image.jpeg';

const DEFAULT_HINT_IMAGE =
  'https://unpkg.com/@olincjs/static-source@0.1.7/source/default-hint-image.png';
